...
export class CreateGroupWithIdRequest extends SpeakeasyBase {
    /**
     * The Id for the group. If not provided a secure random UUID will be generated.
     */
...
export class CreateGroupWithIdResponse extends SpeakeasyBase {
    /**
