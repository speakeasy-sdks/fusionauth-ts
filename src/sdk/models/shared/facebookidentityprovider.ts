...
export class FacebookIdentityProviderData extends SpeakeasyBase {}
...
export class FacebookIdentityProvider extends SpeakeasyBase {
    ...
    @SpeakeasyMetadata({ elemType: FacebookIdentityProviderData })
    @Expose({ name: "data" })
    @Transform(
        ({ value }) => {
            const obj: Record<string, FacebookIdentityProviderData> = {};
            for (const key in value) {
                obj[key] = objectToClass(value[key], FacebookIdentityProviderData);
            }
            return obj;
        },
        { toClassOnly: true }
    )
    data?: Record<string, FacebookIdentityProviderData>;
