...
export class FormFieldData extends SpeakeasyBase {}
...
export class FormField extends SpeakeasyBase {
    ...
    @SpeakeasyMetadata({ elemType: FormFieldData })
    @Expose({ name: "data" })
    @Transform(
        ({ value }) => {
            const obj: Record<string, FormFieldData> = {};
            for (const key in value) {
                obj[key] = objectToClass(value[key], FormFieldData);
            }
            return obj;
        },
        { toClassOnly: true }
